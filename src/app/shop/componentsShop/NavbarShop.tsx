...
const Navbar = () => (
    <nav className="relative flex h-12 md:h-20">
        <div className="bg-zinc-600 w-full flex h-full items-center justify-between px-4 md:px-12">
            ...
            <div className="hidden md:flex space-x-28 ml-8 text-xl font-secondary">
            ...
            <div className="flex items-center space-x-6 ml-4 md:space-x-20 md:mr-8">
                <span className="text-indigo-200  text-3xl mb-1 md:text-6xl md:ml-16 md:mb-4"> 
                    |
                </span>

                {/* Needs to be more opaque when not logged in*/}
                <Link href="/login" className="fill-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"className="size-6 md:size-10 hover:fill-indigo-400">
                    <path fillRule="evenodd" d="M18.685 19.097A9.723 9.723 0 0 0 21.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 0 0 3.065 7.097A9.716 9.716 0 0 0 12 21.75a9.716 9.716 0 0 0 6.685-2.653Zm-12.54-1.285A7.486 7.486 0 0 1 12 15a7.486 7.486 0 0 1 5.855 2.812A8.224 8.224 0 0 1 12 20.25a8.224 8.224 0 0 1-5.855-2.438ZM15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" clipRule="evenodd" />
                    </svg>
                </Link>

                <Link href="/cart" className="fill-indigo-200">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-6 md:size-10 hover:fill-indigo-400">
