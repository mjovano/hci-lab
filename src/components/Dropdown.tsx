...
export default function DropdownMenu() {
  return (
    <Menu as="div" className="flex justify-end">
      <div>
        <MenuButton className="inline-flex w-3xs justify-end gap-x-2 rounded-3xl ml-4 shadow-md bg-zinc-600 p-2 font-semibold font-secondary text-amber-100 hover:bg-zinc-900">
          Products
